...
<head>
    ...
    <x-seo
        title="Géneros de series y películas GL"
        description="Explora series, películas y doramas Girls' Love organizados por género en el catálogo de Mundo Yuri."
        :canonical="route('catalog.genres.index')"
    />
    <x-portal-favicon />
