...
class UpdateCommunityRankRequest extends FormRequest
{
    ...
    {
        /** @var CommunityRank $communityRank */
        $communityRank = $this->route('communityRank');

        return [
            'name' => ['required', 'string', 'max:100'],
            'slug' => ['required', 'string', 'max:100', 'alpha_dash', Rule::unique(CommunityRank::class)->ignore($communityRank)],
